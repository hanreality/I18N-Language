...
class SettingActivity : BaseActivity(), I18NActivityHelper.OnUpdateInterfaceListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvSelectLanguage.text = getString(
            ...
            I18NHelper.getInstance().getSelectLanguageString(this)
        )
        I18NActivityHelper.getInstance().setOnUpdateInterfaceListener(this)
    }
    ...
    private fun listLanguageDialog() {
        ...
        listDialog.setItems(languages) { dialog, which ->
            ...
            I18NHelper.getInstance()
                ...
                .apply(this, intent, I18NActivityHelper.getInstance())
            dialog.dismiss()
        }
        listDialog.show()
    }
